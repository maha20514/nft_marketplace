...
const NFTDetails = () => {
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
     ...
     border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-x-nft-gray-1 "
      >
      ...
      <div className="flex-1 justify-start sm:px-4 p-12
       sm:pb-4"
      >
        ...
        <div className="mt-10">
          <p className=" font-poppins dark:text-white text-nft-black-1 text-xs
           minlg:text-base font-normal"
          >Creator
          </p>
          <div className="flex flex-row items-center mt-3">
            ...
            <p lassName=" font-poppins dark:text-white text-nft-black-1 text-xs
           minlg:text-base font-semibold"
            >{shortenAddress(nft.seller)}
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black-1 border-nft-gray-1 flex flex-row">
           ...
           minlg:text-base font-medium mb-2"
            >Details
            </p>
          </div>
